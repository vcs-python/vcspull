...
def test_get_cli_logger_names_includes_base() -> None:
    ...
    expected = [
        ...
        "vcspull.cli.import_cmd._common",
        "vcspull.cli.import_cmd.codeberg",
        "vcspull.cli.import_cmd.codecommit",
        "vcspull.cli.import_cmd.forgejo",
        "vcspull.cli.import_cmd.gitea",
