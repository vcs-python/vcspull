...
config_dict = {
    ...
    '/home/me/myproject': {
        '.vim': {
            ...
            'shell_command_after':
            'ln -sf /home/me/.vim/.vimrc /home/me/.vimrc'
        },
        '.tmux': {
...
config_dict_expanded = [
    ...
    },
    {
        ...
        'parent_dir': '/home/me/myproject/study/',
        'repo_dir': os.path.join(
            '/home/me/myproject/study/', 'freebsd'
        ),
    ...
    },
    {
        ...
        'parent_dir': '/home/me/myproject/study/',
        'repo_dir': os.path.join(
            '/home/me/myproject/study/', 'sphinx'
        ),
